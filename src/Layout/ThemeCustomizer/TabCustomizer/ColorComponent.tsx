...
import { setColorBackground1, setColorBackground2 } from "@/Redux/Reducer/Layout/ThemeCustomizerSlice";
  ...
  return (
    <>
      ...
      <ul className='layout-grid unlimited-color-layout'>
        ...
        <Button color='primary' className='color-apply-btn color-apply-btn' onClick={OnUnlimitedColorClick}>
          {Apply}
        </Button>
      </ul>
    </>
