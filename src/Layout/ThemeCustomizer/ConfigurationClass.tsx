          ...
          <Container fluid={true} className="bd-example-row">
            ...
            <pre>
              <code>
                ...
                <div>
                  {" "}
                  {"layout_type"}&#58; {ConfigDB.data.settings.layout_type},
                </div>
                <div>
                  {" "}
                  {"layout_type"}&#58; {ConfigDB.data.settings.sidebar.iconType},
                </div>
                ...
                <div>
                  {" "}
                  {"primary_color"}&#58; {ConfigDB.data.color.primary_color},{" "}
                </div>
                <div>
                  {" "}
                  {"secondary_color"}&#58; {ConfigDB.data.color.secondary_color},{" "}
                </div>
                <div>
                  {" "}
                  {"mix_background_layout"}&#58; {ConfigDB.data.color.mix_background_layout},{" "}
                </div>
                <div> &#125;,</div>
                <div> &#125;</div>
                <div> &#125;</div>
