  ...
  return (
    <>
      <tr>
        ...
        <td style={{ textAlign: "center", background: "rgba(42, 86, 153, 0.1)", display: "block", padding: "35px 0 18px" }}>
      ...
      <tr>
        ...
        <td style={{ textAlign: "center", background: "rgba(42, 86, 153, 0.1)", display: "block", paddingBottom: 18 }}>
