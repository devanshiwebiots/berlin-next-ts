...
const InvoiceAddress = () => {
  return (
    <td>
      <span style={{ fontSize: 16, display: "block", fontWeight: 600, color: "var(--theme-default)", marginBottom: 14 }} >{InvoiceTo} :</span>
      <span style={{ fontSize: 16, display: "block", fontWeight: 600, color: "var(--theme-default)", marginBottom: 8 }} >Brooklyn Simmons</span>
