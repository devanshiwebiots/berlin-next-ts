        ...
        <tbody>
          <tr style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }} >
            <td>
              ...
              <h4 style={{ fontWeight: 600, margin: "12px 0 5px 0", fontSize: 16, color: "var(--theme-deafult)" }}>Leslie Alexander</h4>
            ...
            <td>
              ...
              <h4 style={{ fontWeight: 600, margin: "12px 0 5px 0", fontSize: 26,  color: "var(--theme-deafult)" }}>$175.00</h4>
