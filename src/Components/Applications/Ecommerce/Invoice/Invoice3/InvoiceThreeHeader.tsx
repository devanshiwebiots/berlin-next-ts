...
const InvoiceThreeHeader = () => {
  return (
    <td>
      <Table className="table-responsive" style={{ width: "100%", backgroundImage: `url(${ImagePath}/email-template/invoice-3/bg.png)`, backgroundPosition: "center", backgroundSize: "cover", backgroundRepeat: "no-repeat", borderRadius: 10 }} >
        <tbody>
          <tr>
            <td style={{ padding: "30px 0 30px 30px" }}>
              <img src={`${ImagePath}/logo/logo-1.png`} alt="logo" />
