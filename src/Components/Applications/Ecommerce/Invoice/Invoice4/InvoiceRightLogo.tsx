...
const InvoiceRightLogo = () => {
  return (
    <td>
      <img className="img-fluid for-light" src={`${ImagePath}/logo/logo-1.png`} alt="logo" style={{ marginBottom: 14 }} />
      <img className="img-fluid for-dark" src={`${ImagePath}/logo/logo.png`} alt="logo" style={{ marginBottom: 14 }} />
