...
import { setModal } from "@/Redux/Reducer/LetterBoxSlice";
...
const AddLabelModal = () => {
  ...
  return (
    <Modal isOpen={modal} size="lg" id="label-pill-modal" >
      ...
      <ModalBody>
        <Form>
          <Row className="g-sm-3 g-2 custom-input">
            ...
            <Col sm="2" xs="2">
              <Input className="form-control-color" id="exampleColorInput" type="color" defaultValue="#2A5699" title="Choose your color" />
            </Col>
          </Row>
        </Form>
      </ModalBody>
