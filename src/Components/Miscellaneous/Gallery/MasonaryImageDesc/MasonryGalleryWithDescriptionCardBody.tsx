                ...
                <Item original={`${ImagePath}/${element.src}`} width="700" height="750" caption={description}>
                  {({ ref, open }) => (
                    <Link href={Href} onClick={open}>
                      <img className="img-thumbnail p-2 rounded-0 rounded-top-1" ref={ref as unknown as React.MutableRefObject<HTMLImageElement>} src={`${ImagePath}/${element.src}`} alt="images" />
