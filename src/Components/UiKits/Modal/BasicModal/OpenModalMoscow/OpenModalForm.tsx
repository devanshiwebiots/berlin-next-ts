import { EmailAddress, EnterYourFirstName, EnterYourLastName, FirstName, LastName, BerlinEmail, SignUp, TermsAndCondition } from "@/Constant";
            ...
            <Row>
              ...
              <Col md="12">
                <FormGroup>
                  ...
                  <Field type="text" name="email" className={`form-control ${formSubmit && `${errors.email ? "is-valid" : "is-invalid"}`}`} placeholder={BerlinEmail} />
                </FormGroup>
              </Col>
              <Col md="12">
                <FormGroup check>
