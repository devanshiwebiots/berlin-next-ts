...
import { Address, BerlinMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName } from "@/Constant";
  ...
  return (
    <>
      ...
      <Col sm="6">
        ...
        <Input value={email} onChange={getUserData} name="email" type="email" placeholder={BerlinMail} />
      </Col>
      <Col sm="12">
