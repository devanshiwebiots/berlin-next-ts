...
import { handleBackButton, handleNextButton, setBasicInputFormValue } from "@/Redux/Reducer/FormLayout/NumberingWizardSlice";
      ...
      <Card className='height-equal'>
        ...
        <CardBody className='basic-wizard important-validation'>
          ...
          <div className='wizard-footer d-flex gap-2 justify-content-end'>
            ...
            <Button disabled={showFinish ? true : false} color='primary' onClick={() => dispatch(handleNextButton())}>
