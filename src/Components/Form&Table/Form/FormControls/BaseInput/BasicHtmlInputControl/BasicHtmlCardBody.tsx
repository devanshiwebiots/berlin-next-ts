    ...
    <CardBody className="custom-input">
      <Row>
        <Col>
          ...
          <CommonFormGroup inputType="week" label={BasicWeek} colSm="9" inputClass="digits" defaultValue={FullWeek} />
          <Row className="mb-3">
          ...
          <CommonFormGroup inputType="time" label={BasicTime} colSm="9" inputClass="digits" />
          <CommonFormGroup inputType="color" colSm="2" label={BasicColorPicker} labelClass="pt-0" inputClass="form-control-color" defaultValue="#2A5699" />
