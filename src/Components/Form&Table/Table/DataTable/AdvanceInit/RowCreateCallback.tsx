...
import { RowCreateCallColumn, RowCreateCallData, RowCreateCallList } from "@/Data/Form&Table/Table/DataTable/RowCreateCallbackData";
    ...
    <Col sm="12">
      <Card className="basic-data-table">
        <CardHeader className="pb-0 card-no-border">
          ...
          {RowCreateCallData.map((item, index) => (<span key={index}>{item}</span>))}
        </CardHeader>
        <CardBody>
