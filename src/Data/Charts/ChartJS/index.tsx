  ...
  datasets: [
    {
      ...
      borderColor: primary,
      highlightFill: "rgba(42, 86, 153, 0.6)",
...
export const LineChartData = {
  ...
  datasets: [
    {
      fill: true,
      backgroundColor: "rgba(42, 86, 153, 0.6)",
      borderColor: primary,
      pointColor: primary,
    ...
    {
      fill: true,
      backgroundColor: "rgba(88, 178, 50, 0.2)",
      borderColor: primary,
      pointColor: primary,
...
export const DoughnutChartData = {
  ...
  datasets: [
    {
      data: [300, 50, 100],
      backgroundColor: ["#2A5699", "rgba(221, 112, 49, 1)", "#51bb25"],
    },
  ],
};
  ...
  datasets: [
    {
      ...
      backgroundColor: ["rgba(42, 86, 153, 1)", "#f8d62b", "#51bb25", "#a927f9", "rgba(221, 112, 49, 1)"],
    },
  ],
};
