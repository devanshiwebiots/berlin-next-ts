...
export const ArticalData = [
  {
    ...
    title: "Articles",
    icon: <FileText />,
    paragraph:"How little experience or technical knowledge you currently have. The web is a very big place, and internet user, you probably visit several websites every day.",
    box: "6",
  },
  {
    id: 2,
  ...
  },
  {
    id: 3,
    title: "Support",
    paragraph: "The customer support industry is renaissance. Customer support as a specialty is coming into its own, offering companies a competitive advantage that’s difficult.",
    icon: <Aperture />,
    sm: "6",
    box: "12",
  },
