...
export const MenuList: SidebarMenuType[] = [
  ...
  },
  {
    ...
    menu: [
      ...
      { path: "/app/file_manager", icon: "file", title: "File Manager", bookmark: true, type: "link" },
      {
        title: "Ecommerce",
        id: 6,
        icon: "ecommerce",
        ...
        subMenu: [
          ...
          { path: "/app/ecommerce/recent_order", title: "Order History", type: "link" },
          {
            ...
            type: "sub",
            subMenu: [
              { path: "/others/invoice/invoice_1", title: "Invoice-1", type: "link" },
              { path: "/others/invoice/invoice_2", title: "Invoice-2", type: "link" },
              { path: "/others/invoice/invoice_3", title: "Invoice-3", type: "link" },
              { path: "/others/invoice/invoice_4", title: "Invoice-4", type: "link" },
              { path: "/others/invoice/invoice_5", title: "Invoice-5", type: "link" },
      ...
      { path: "/app/letter_box", icon: "email", title: "Letter Box", bookmark: true, type: "link" },
      {
        title: "Chat",
        id: 8,
        icon: "chat",
      ...
      { path: "/app/bookmarks", icon: "bookmark", type: "link", title: "Bookmarks", bookmark: true, id: 10 },
    ...
    menu: [
      {
        ...
        subMenu: [
          ...
          { path: "/ui_kits/divider", title: "Divider", badge: true, badgeName: "Trending", badgeColor: "light-warning", type: "link" },
          ...
          { path: "/ui_kits/placeholders", title: "Placeholders", badge: true, badgeName: "New", badgeColor: "light-success", type: "link" },
          ...
          { path: "/ui_kits/offcanvas", title: "Offcanvas", badge: true, badgeName: "Trending", badgeColor: "light-warning", type: "link" },
          { path: "/ui_kits/navigate_links", title: "Navigate Links", badge: true, badgeName: "New", badgeColor: "light-success", type: "link" },
...

      {
        ...
        subMenu: [
          ...
          { path: "/bonus_ui/ratios", title: "Ratios", badge: true, badgeName: "Trending", badgeColor: "light-warning", type: "link" },
...

  {
    ...
    menu: [
...

      {
        ...
        active: false,
        subMenu: [
          { path: "/blog/blog_grids", title: "Blog Grids", type: "link" },
