...
export const VerticalSliderSubTitle = [
  {
    text: "Height of image can be set by adding ",
    code: "vertical-sweeper & sweeper-h ",
  },
  {
    text: "classes and images will be swept vertically.",
  },
];

export const NestedSwiperSubTitle = [
  {
    text: "Height of image can be set by adding ",
    code: "nested-horizontal-swiper & sweeper-h ",
  },
  {
    text: "classes and images will be swept vertically & horizontally.",
  },
];

export const MouseWheelVariantSubTitle = [
  {
    text: "Height of image can be set by adding ",
    code: "mouseweel-swiper & sweeper-h ",
  },
  {
    text: "classes and images will be swept through mouseweel.",
  },
];
...
export const EffectCoverflowSubTitle = [
  {
    text: "Height of image can be set by adding ",
    code: "coverflow-slider ",
  },
  {
    text: "classes and images will be swept 3D way.",
  },
];
...
export const WithControlDataList = [
  { id: 4, image: "slider/6.jpg" },
  { id: 5, image: "slider/7.jpg" },
  { id: 6, image: "slider/10.jpg" },
  { id: 7, image: "slider/4.jpg" },
  { id: 8, image: "slider/1.jpg" },
];
...
export const WithIndicatorDataList = [
  { id: 20, image: "slider/3.jpg" },
  { id: 21, image: "slider/8.jpg" },
  { id: 22, image: "slider/10.jpg" },
];
...
export const CrossFadeData = [
  ...
  {
    text: " to your carousel to animate slides with a fade transition instead of a slide. Depending on your carousel content.",
  },
];
...
export const IndividualIntervalData = [
  {
    image: "slider/5.jpg",
    interval: 1000,
  },
...
export const NestedSwiperData = ["8","10","11","1","2"];

export const MouseWheelVariantData = ["3","4","5","6","7","8","9","10","11"];

export const AutoPlayVariantData = ["11","2","3","4","5","6","7","8","9","10"];