...
export const FlushListData = [{ name: "PRODUCT DETAILS",icon:"warning" }, { name: "CART",icon:"cart" }, { name: "CHECKOUT",icon:"checked" }];
{
  /* <li class="list-group-item"><i class="icofont icofont-chart-histogram-alt"></i>CHART</li>
