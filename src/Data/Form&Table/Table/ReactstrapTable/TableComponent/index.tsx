...
import { DismissibleAlerts } from "@/Components/Form&Table/Table/ReactstrapTable/TableComponent/Common/DismissibleAlerts";
import { AlertsWithIcons } from "@/Components/Form&Table/Table/ReactstrapTable/TableComponent/Common/AlertsWithIcons";
  ...
  },
  {
    ...
    tableColData: (
      <UncontrolledDropdown>
        <DropdownToggle color="primary" className="w-10" caret>
          Primary
        </DropdownToggle>
        <DropdownMenu>
...
export const ProgressTableData = [
  ...
  },
  {
    ...
    tableColData: <Progress striped color="primary" value={75} animated />,
    details: [
      {
