...
export const HtmlColumnData = [
  {
    ...
    cv: (
      <div className="action">
        <Link className="pdf" onClick={handlePDFClick} rel="/assets/images/favicon.png" href="/public/assets/pdf/sample.pdf" target="_blank">
  ...
  },
  {
    ...
    cv: (
      <div className="action">
        <Link className="pdf" href="/assets/pdf/sample.pdf" onClick={handlePDFClick} target="_blank">
          <i className="icofont icofont-file-pdf"> </i>
        </Link>
      </div>
    ),
